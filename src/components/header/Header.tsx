    ...
    <nav
      ...
      <div className="flex w-full flex-wrap items-center justify-evenly px-3 pl-8 pr-8">
        ...
        <div
          ...
          {/* <!-- Logo --> */}
          <a
            className="gap-8 mb-4 me-5 ms-2 mt-3 flex items-center lg:mb-0 lg:mt-0 w-[150px]"
            href="#">
            <img
          ...
          <ul
            className="list-style-none me-auto flex flex-col ps-0 lg:flex-row w-[550px] gap-6"
        ...
        {/* <!-- Right elements --> */}
        <div className="relative flex items-center w-[250px] gap-6">
          {/* <!-- Cart Icon --> */}
          <a
